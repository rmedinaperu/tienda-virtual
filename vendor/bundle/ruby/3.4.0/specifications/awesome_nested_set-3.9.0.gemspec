# -*- encoding: utf-8 -*-
# stub: awesome_nested_set 3.9.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<activerecord>.freeze, [">= 4.0.0".freeze, "< 8.2".freeze])
  ...
  s.add_development_dependency(%q<rspec-rails>.freeze, [">= 4.0.0".freeze, "< 8.0".freeze])
end
